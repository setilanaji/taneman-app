...
public class FavoritePlantAdapter extends RecyclerView.Adapter<FavoritePlantAdapter.ViewHolder>  {

    private final Context context;
    private List<Plant> items;
    private FavoritePlantAdapter.PostItemListener itemListener;

    private FavoriteClickListener favoriteClickListener;


    public FavoritePlantAdapter(Context context, List<Plant> items , FavoritePlantAdapter.PostItemListener itemListener, FavoriteClickListener favoriteClickListener) {
    ...
    @NonNull
    @Override
    public FavoritePlantAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_plant_list_item, parent, false);
        return new FavoritePlantAdapter.ViewHolder(view, this.itemListener);
    }

    @Override
    public void onBindViewHolder(@NonNull FavoritePlantAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        FavoritePlantAdapter.PostItemListener itemListener;

        public ViewHolder(@NonNull View itemView, FavoritePlantAdapter.PostItemListener itemListener) {
            super(itemView);
