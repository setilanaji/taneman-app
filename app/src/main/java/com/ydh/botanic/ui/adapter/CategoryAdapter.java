...
public class CategoryAdapter  extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
    ...
    private CategoryAdapter.PostItemListener itemListener;

    public CategoryAdapter(Context context, List<Category> items , CategoryAdapter.PostItemListener itemListener) {
    ...
    public CategoryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new CategoryAdapter.ViewHolder(view, this.itemListener);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        CategoryAdapter.PostItemListener itemListener;

        @BindView(R.id.textView_category_name_list)
        TextView categoryName;

        @BindView(R.id.imageView_category_list)
        ImageView categoryImage;

        public ViewHolder(@NonNull View itemView, CategoryAdapter.PostItemListener itemListener) {
            super(itemView);
